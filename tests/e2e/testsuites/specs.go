...
func (pod *PodDetails) SetupDeployment(client clientset.Interface, namespace *v1.Namespace, csiDriver driver.DynamicPVTestDriver) (*TestDeployment, []func()) {
	...
	storageClass := csiDriver.GetDynamicProvisionStorageClass(driver.GetParameters(volume.VolumeType, namespace), volume.MountOptions, volume.ReclaimPolicy, volume.AllowVolumeExpansion, volume.VolumeBindingMode, volume.AllowedTopologyValues, namespace.Name)
...
//func (volume *VolumeDetails) SetupPreProvisionedCleanupStorageClass(client clientset.Interface, namespace *v1.Namespace, csiDriver driver.PreProvisionedVolumeTestDriver) *TestStorageClass {
//	sc := csiDriver.GetDynamicProvisionStorageClassToCleanup(driver.GetParameters(volume.VolumeType, namespace), namespace.Name)
