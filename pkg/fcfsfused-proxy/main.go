...
import (
	...
	server "vazmin.github.io/fastcfs-csi/pkg/fcfsfused-proxy/server"
)
...
var (
	blobfuseProxyEndpoint = flag.String("fcfsfused-proxy-endpoint", "unix://tmp/fcfsfused-proxy.sock", "fcfsfused-proxy endpoint")
)
