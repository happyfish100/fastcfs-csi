...
type MountServiceClient interface {
	MountFcfsFused(ctx context.Context, in *MountFcfsFusedRequest, opts ...grpc.CallOption) (*MountFcfsFusedResponse, error)
}
...
func (c *mountServiceClient) MountFcfsFused(ctx context.Context, in *MountFcfsFusedRequest, opts ...grpc.CallOption) (*MountFcfsFusedResponse, error) {
	out := new(MountFcfsFusedResponse)
	err := c.cc.Invoke(ctx, "/MountService/MountFcfsFused", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MountServiceServer interface {
	MountFcfsFused(context.Context, *MountFcfsFusedRequest) (*MountFcfsFusedResponse, error)
...
func (UnimplementedMountServiceServer) MountFcfsFused(context.Context, *MountFcfsFusedRequest) (*MountFcfsFusedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MountFcfsFused not implemented")
}
...
func _MountService_MountFcfsFused_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MountFcfsFusedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MountServiceServer).MountFcfsFused(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/MountService/MountFcfsFused",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MountServiceServer).MountFcfsFused(ctx, req.(*MountFcfsFusedRequest))
	}
...
var MountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MountFcfsFused",
			Handler:    _MountService_MountFcfsFused_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "fcfs_fused_mount.proto",
}
